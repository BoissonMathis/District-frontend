import { PasswordForgetForm } from "../componants/PasswordForgetForm";
...
export function PasswordForget () {
    ...
    return (
        <div className="col gap-16 items-center justify-center h-screen b-beige">
            ...
            <span>Veuillez renseigner vote Email que nous puissions vous envoyer votre mot de passe !</span>
            <PasswordForgetForm />
        </div>
    )
}